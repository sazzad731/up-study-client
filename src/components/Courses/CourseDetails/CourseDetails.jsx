...
const CourseDetails = () => {
  ...
  const { _id, title, details, topic } = selected;
    ...
    <div>
      <div className="mb-10">
        ...
        <div className="text-center">
          <Link to={`/courses/chackout/${_id}`} className="bg-black dark:bg-slate-800 text-white text-lg font-medium py-5 px-7 rounded-full">
            Get premium access
          </Link>
        </div>
      </div>
